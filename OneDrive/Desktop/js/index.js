...
// PARA SIMULADOR INTERACTIVO DESCOMENTAR ESTO (desde linea 25 hasta 38) !!!!!!!!!  
/*
function elegir() {
...
function init() {
    ...
    //Para ELBOTON descomentar desde linea 53 hasta linea 85 
    ...
    function destruccion() {
        ...
        continuarALosSiguientes.innerHTML = "ver todos los productos elegidos";
        continuarALosSiguientes.setAttribute("href", "final.html");
        pepe.appendChild(continuarALosSiguientes)
    }


    //Generador DOM Random descomentar linea 87 hasta linea 127
    /*
